...
class LCNN(nn.Module):
    ...
    def __init__(self, in_channels=1, num_classes=2, dropout_rate=0.75):
        ...
        # FC layers exactly as in the paper with 10.2M + 371K parameters
        # FC_29: 160 features - exactly as in original paper
        target_input_size = 62500  # 53*37*32 = 62500 (as in original)
        self.fc1 = nn.Linear(target_input_size, 160)  # 62500 * 160 = 10.0M parameters
